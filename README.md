...
リモートリポジトリーは、インターネット上の保存区域。 ローカルリポジトリは、自身のPC上の保存区域。


## プッシュとマージの違いは何でしょうか？
プッシュは、ローカルリポジトリの変更履歴をリモートリポジトリーに共有すること マージは、ブランチを統合させることで、反映先の違いと、共有と統合の違い。


## コミットとプッシュの違い
反映先が異なる点。コミットは、ローカルリポジトリに反映。 プッシュはリモートリポジトリーに反映。
